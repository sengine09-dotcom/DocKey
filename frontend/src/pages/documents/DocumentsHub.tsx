...
const SYSTEMS = [
  {
    ...
    description: 'จัดการเอกสารฝั่งขาย ตั้งแต่ใบเสนอราคาจนถึงใบเสร็จรับเงิน',
    color: 'blue',
    types: [
    ...
    flow: 'ใบเสนอราคา → ใบรับมัดจำ → ใบแจ้งหนี้ → ใบเสร็จ',
  },
  {
    key: 'purchase',
    ...
    description: 'จัดการใบสั่งซื้อและการสั่งซื้อจากผู้ขาย',
    color: 'violet',
    types: [
      { key: 'purchase_order', label: 'ใบสั่งซื้อ', icon: '📦' },
    ],
    flow: 'สร้าง PO → อนุมัติ → รับสินค้า',
  },
  {
    key: 'operations',
